...
import {
  Award, Users, Building2, Sprout, ShieldCheck, Trophy, Quote,
  Briefcase, GraduationCap, Globe2, Bug, Leaf, Microscope,
  HeartHandshake, Target, Compass, Flag, MapPin,
} from "lucide-react";
...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Advanced Indian Pest Solution Pvt. Ltd. — founded 2010 in Kolkata by agronomist Anup Karmakar. 40,000+ customers, CIB-approved, women-led opportunities, national industry leadership." },
      { property: "og:title", content: "About AIPS — Scientific, Sustainable Pest Management Since 2010" },
      { property: "og:description", content: "Founded by Anup Karmakar (National Ambassador & General Secretary, PMA). 40,000+ customers across 10 states." },
    ],
  }),
  component: About,
});
...
const timeline = [
  { year: "2010", title: "Founded in Kolkata", body: "Anup Karmakar (B.Sc. Agriculture) launches Advanced Indian Pest Solution with a vision to create safer, healthier and pest-free environments through advanced pest management." },
  { year: "2013", title: "First HACCP contracts", body: "Food-safe protocols aligned to HACCP win our first hospitality and food-processing accounts across West Bengal." },
  { year: "2016", title: "Expansion beyond Bengal", body: "Operations open in Jharkhand, Bihar and Odisha — same technicians, same protocol, everywhere." },
  { year: "2019", title: "Herbal protocol launched", body: "Dedicated herbal treatment programme for newborns, elderly and asthmatic households." },
  { year: "2021", title: "Pan-India footprint", body: "Teams established in Pune, Mumbai, Delhi NCR, Lucknow, Varanasi and Guwahati; women-led professional opportunities scaled across branches." },
  { year: "2023", title: "Most Popular Leader Award", body: "Anup Karmakar recognised as Most Popular Leader in Public Health & Hygiene Services 2023 by News18 Network." },
  ...
  { year: "2025", title: "Pest Mentor Signature Award", body: "Voice of the Industry 2025 by E & G Pathway — for contribution to India's professional pest management sector." },
  { year: "2026", title: "40,000+ customers · 19 cities", body: "Serving 19 cities across 10 states with a written warranty on every job — 5 yrs post-construction, 10 yrs pre-construction on termite." },
];

const awards = [
  { icon: Trophy, title: "Pest Mentor Signature Award", body: "Voice of the Industry 2025 · E & G Pathway" },
  { icon: Award, title: "Most Popular Leader 2023", body: "Public Health & Hygiene Services · News18 Network" },
...
function About() {
  return (
    <>
      <PageHero
        eyebrow="Since 2010 · Kolkata"
        title={<>Scientific, sustainable, <em className="text-amber">women-supported</em> pest management.</>}
        intro="Advanced Indian Pest Solution Pvt. Ltd. was founded to create safer, healthier and pest-free environments through advanced techniques and responsible service — while championing women-led professional opportunities in the pest industry."
      />
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <article className="rounded-3xl border border-border bg-card p-8 shadow-[var(--shadow-card)]">
            <div className="flex items-center gap-3">
              <span className="grid h-11 w-11 place-items-center rounded-2xl bg-forest-deep text-amber"><Target className="h-5 w-5" /></span>
              <h3 className="font-serif text-2xl text-foreground">Our Mission</h3>
            </div>
            <p className="mt-4 leading-relaxed text-muted-foreground">
              To provide safe, scientific and sustainable pest management solutions that protect health, property and
              environment — while ensuring customer satisfaction and long-term prevention.
            </p>
          </article>
          <article className="rounded-3xl border border-border bg-card p-8 shadow-[var(--shadow-card)]">
            <div className="flex items-center gap-3">
              <span className="grid h-11 w-11 place-items-center rounded-2xl bg-forest-deep text-amber"><Compass className="h-5 w-5" /></span>
              <h3 className="font-serif text-2xl text-foreground">Our Vision</h3>
            </div>
            <p className="mt-4 leading-relaxed text-muted-foreground">
              To become a trusted leader in pest management by combining innovation, eco-friendly practice, technology
              and empowered professional service.
            </p>
          </article>
        </div>
      </Section>
      ...
      <Section bg="cream" eyebrow="Meet the founder" title="Anup Karmakar">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-center">
          ...
          <div>
            ...
            <p className="mt-4 leading-relaxed text-muted-foreground">
              With over 20 years in pest management, public health services and professional training, Anup Karmakar is
              a recognised leader in India's pest industry. He has contributed extensively to urban pest control, public
              health awareness, vector management, food safety and professional skill development — across India and on
              international platforms.
            </p>
            <p className="mt-3 leading-relaxed text-muted-foreground">
              As Founder of Advanced Indian Pest Solution Pvt. Ltd., he is committed to delivering scientific,
              sustainable and innovative pest management solutions for residential, commercial, industrial and public
              health sectors.
            </p>
            ...
            <blockquote className="mt-6 rounded-2xl border-l-4 border-amber bg-cream-warm p-5">
              ...
              <p className="mt-2 font-serif text-lg italic leading-relaxed text-foreground">
                To promote safer environments, healthier communities, and scientifically managed pest control systems
                through innovation, education and sustainable practices.
              </p>
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-[1.3fr_1fr]">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-forest">Areas of expertise</p>
            <h4 className="mt-2 font-serif text-2xl text-foreground md:text-3xl">A career spent across every corner of pest science.</h4>
            <div className="mt-6 grid gap-3 sm:grid-cols-2">
              {expertise.map((e) => (
                <div key={e.title} className="flex items-start gap-3 rounded-2xl border border-border bg-card p-4">
          ...
          <div className="rounded-3xl bg-forest-deep p-8 text-cream shadow-[var(--shadow-lifted)]">
            <div className="flex items-center gap-2 text-amber">
              ...
              <p className="text-xs font-semibold uppercase tracking-widest">International exposure</p>
            </div>
      ...
      <Section eyebrow="Meet the co-founder" title="Ashwini Sanjay Yeljale">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-center">
          <div className="order-2 lg:order-1">
            <div className="flex flex-wrap items-center gap-2">
              <span className="rounded-full bg-forest-deep px-3 py-1 text-xs font-semibold uppercase tracking-widest text-amber">Director</span>
              <span className="rounded-full border border-forest/20 bg-cream px-3 py-1 text-xs font-semibold text-forest-deep">B.Sc. Agriculture</span>
            ...
            <p className="mt-4 leading-relaxed text-muted-foreground">
              Ashwini Sanjay Yeljale plays a key role in leading Advanced Indian Pest Solution Pvt. Ltd. toward
              continuous growth. With strong experience in business management and pest industry knowledge, she is
              committed to maintaining quality, innovation and customer satisfaction — building long-term relationships
              with clients and partners through teamwork and professionalism.
            </p>
            <blockquote className="mt-6 rounded-2xl border-l-4 border-amber bg-cream-warm p-5">
              <Quote className="h-5 w-5 text-amber" />
              <p className="mt-2 font-serif text-lg italic leading-relaxed text-foreground">
                Our mission is to provide the best quality products and services while building long-term trust with
                our customers. We continuously work toward innovation, growth and excellence in every aspect of our
                business.
              </p>
      ...
      {/* Timeline */}
      <Section bg="cream" eyebrow="Our journey" title="Fifteen years, one uncompromising standard." intro="From one office in Kolkata to 19 cities across 10 states — every milestone earned by keeping the same promise.">
      ...
      <Section bg="cream" eyebrow="Why AIPS" title="A scientific approach, from inspection to prevention.">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            { t: "Inspection & assessment", b: "Every job starts with a site walk, not a spray gun." },
            { t: "Customised solution", b: "Protocol built for your building, pest and household." },
            { t: "Safe treatments", b: "CIB-approved actives at strict label-rate dilutions." },
            { t: "Long-term prevention", b: "5-yr post-construction · 10-yr pre-construction termite warranty." },
            { t: "Eco-friendly options", b: "Herbal protocol for newborns, elderly and asthmatics." },
            { t: "Trained professionals", b: "31-strong team, 90+ hrs in-house training before first visit." },
            { t: "Advanced technology", b: "International fumigation and IPM standards, applied locally." },
            { t: "Women empowerment", b: "Active support for women-led professional opportunities." },
          ].map((c) => (
      ...
      <Section eyebrow="The chemistry behind the calm" title="Industry-grade actives. Calibrated to the milligram.">
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <p className="text-base leading-relaxed text-muted-foreground md:text-lg">
            We use the same actives the global pest industry uses — Envu, FMC, Syngenta, UPL, Arbuda and Sandhya — at
          ...
          <div>
            ...
            <div className="mt-6 grid grid-cols-3 gap-4">
              {[
                ...
                { icon: Building2, label: "19 cities" },
