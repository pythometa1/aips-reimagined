export const site = {
  ...
  email: "advancedindianpestsolution@gmail.com",
  ...
  founderLinkedIn: "https://www.linkedin.com/in/anup-karmakar-7ba3a928a/",
} as const;
...
export const statesServed = ["West Bengal"];

export const stats = [
  { value: "40,000+", label: "Homes & offices" },
  { value: "15+", label: "Years of practice" },
  { value: "8", label: "Cities in West Bengal" },
  { value: "90+ hrs", label: "In-house training" },
];
